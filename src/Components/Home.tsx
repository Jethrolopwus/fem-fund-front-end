    ...
    <div className="min-h-screen overflow-x-hidden">
      <section className="pb-10">
        <div className="flex flex-wrap md:flex-nowrap mx-8 justify-center items-center gap-10">
          <div className="w-full md:w-[640px] text-center md:text-left">
            <h1 className="text-[36px] md:text-[50px] lg:text-[90px] font-normal font-serif leading-tight">
              Empowering Women Through Shared Savings!
            </h1>
            <p className="text-base md:text-xl leading-6 font-normal w-full md:w-[480px] mt-4 mx-auto md:mx-0 font-serif">
              Join a community where women pool resources, buy essential items,
              and share them fairly every month.
            </p>
            <button className="py-2 px-6 border bg-[#0E369E] mt-4 text-white rounded-xl hover:bg-blue-500">
              Get started today
            </button>
          </div>
